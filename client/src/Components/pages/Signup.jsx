...
>
        ...
        <div className="relative mb-4">
          <input
            ...
            placeholder="Email"
            className={`px-4 py-2 w-full bg-transparent rounded-md border ${emailError ? 'border-red-500' : 'border-gray-300'} transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-pink-500 placeholder-black`}
            required
          />
        ...
        {/* Account Type Select */}
        <div className="relative mb-4">
          <label htmlFor="typeofacc" className="block mb-2 font-medium text-white">Account Type:</label>
          <select
            name="typeofacc"
            id="typeofacc"
